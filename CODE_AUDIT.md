...
| **3. Misplaced Helpers** | | | | | |
| 3.1 | Fixed | `src/components/Transcript.tsx` | `cleanDisplayText()` — pure text processing in component file | Separation of concerns; testability | a1fc1e2 |
...
**Totals:** 159 issues — 126 Open, 0 In-progress, 30 Fixed, 3 Skipped
